...
# CARICATURE, not anatomy. The cast is deliberately pushed well past human
# proportion: a head about a quarter of total height, a stubby body, and hands
# and feet far too big for it. That is what makes a chunky low-poly character
# read as FUNNY rather than as a mannequin - the silhouette is all head and
# boots, it reads instantly at chase-camera distance, and the exaggerated
# extremities give the walk cycle something to throw around.
DEFAULTS = dict(
    head_r_frac=0.232,
    shoulder_frac=0.575,
    hip_frac=0.415,
    ...
    knee_x_mult=0.92,
    foot_x_mult=0.82,
    upperarm_len_frac=0.155,
    forearm_len_frac=0.140,
    torso_r_top_frac=0.170,
    torso_r_bot_frac=0.185,
    hip_r_frac=0.160,
    upperarm_r_frac=0.082,
    forearm_r_frac=0.072,
    hand_r_frac=0.092,
    thigh_r_frac=0.098,
    shin_r_frac=0.078,
    shoe_len_frac=0.205,
...
FATHER = dict(
    ...
    belly=0.42,
    head_r_frac=0.215,
    shoulder_w_frac=0.205,
    hip_w_frac=0.155,
    torso_r_bot_frac=0.215,
